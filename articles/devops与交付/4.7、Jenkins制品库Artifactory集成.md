...
![image.png](assets/devops与交付/4.7、Jenkins制品库Artifactory集成/4.7、Jenkins制品库Artifactory集成-1.png)

  

## 配置artifactory信息

![image.png](assets/devops与交付/4.7、Jenkins制品库Artifactory集成/4.7、Jenkins制品库Artifactory集成-2.png)
