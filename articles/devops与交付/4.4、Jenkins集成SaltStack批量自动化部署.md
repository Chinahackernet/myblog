...
![](assets/devops与交付/4.4、Jenkins集成SaltStack批量自动化部署/4.4、Jenkins集成SaltStack批量自动化部署-1.png)
...
![](assets/devops与交付/4.4、Jenkins集成SaltStack批量自动化部署/4.4、Jenkins集成SaltStack批量自动化部署-2.png)

-   生成Jenkinfile方法（项目->Pipeline Syntax->片段生成器）

![](assets/devops与交付/4.4、Jenkins集成SaltStack批量自动化部署/4.4、Jenkins集成SaltStack批量自动化部署-3.png)
...
![](assets/devops与交付/4.4、Jenkins集成SaltStack批量自动化部署/4.4、Jenkins集成SaltStack批量自动化部署-4.png)