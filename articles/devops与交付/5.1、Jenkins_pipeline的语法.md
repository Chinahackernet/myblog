...
![](assets/devops与交付/5.1、Jenkins_pipeline的语法/5.1、Jenkins_pipeline的语法-1.png)
...
（1）、声明式Pipeline: 使用agent指定运行的slave节点可以是label。
...
（2）、脚本式Pipleine： 使用node指定运行slave可以是label。
...
![](assets/devops与交付/5.1、Jenkins_pipeline的语法/5.1、Jenkins_pipeline的语法-2.png)

  

## 3.3、SCM（管理）

Jenkinsfile编写完成后上传到gitlab进行版本控制，使用时，通过项目的配置gitlab仓库地址和分支信息以及文件名称信息。

  
![](assets/devops与交付/5.1、Jenkins_pipeline的语法/5.1、Jenkins_pipeline的语法-3.png)

![](assets/devops与交付/5.1、Jenkins_pipeline的语法/5.1、Jenkins_pipeline的语法-4.png)