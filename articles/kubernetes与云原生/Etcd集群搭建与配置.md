Etcd 是 CoreOS 基于 Raft 开发的分布式 key-value 存储，可用于服务发现、共享配置以及一致性保障（如数据库选主、分布式锁等）。Etcd 集群配置分为三种:

-   静态发现  
    
-   Etcd 动态发现  
    
-   DNS 动态发现：通过 DNS 的 SRV 解析动态发现集群  
    

本文主要基于静态发现 和 DNS 动态发现两种方式，并结合自签的TLS证书来创建集群。

# 环境准备

此环境实际用于 k8s 中的ETCD集群使用，用于本次文档

<table class="lake-table" style="text-align: left; width: 721px;"><colgroup><col span="1" width="144" /><col span="1" width="144" /><col span="1" width="144" /><col span="1" width="144" /><col span="1" width="144" /></colgroup><thead><tr style="height: 33px;"><td style="background-color: #FAFAFA;">主机名</td><td style="background-color: #FAFAFA;">角色</td><td style="background-color: #FAFAFA;">IP</td><td style="background-color: #FAFAFA;">系统版本</td><td style="background-color: #FAFAFA;">内核版本</td></tr></thead><tbody><tr style="height: 33px;"><td>node01.k8s.com</td><td>node01</td><td>192.168.1.91</td><td>CentOS 7.7</td><td>5.1.4-1.el7.elrepo.x86_64</td></tr><tr style="height: 33px;"><td>node02.k8s.com</td><td>node02</td><td>192.168.1.92</td><td>CentOS 7.7</td><td>5.1.4-1.el7.elrepo.x86_64</td></tr><tr style="height: 33px;"><td>node03.k8s.com</td><td>node03</td><td>192.168.1.93</td><td>CentOS 7.7</td><td>5.1.4-1.el7.elrepo.x86_64</td></tr></tbody></table>
