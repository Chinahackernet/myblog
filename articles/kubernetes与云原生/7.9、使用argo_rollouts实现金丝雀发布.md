...
![image.png](assets/kubernetes与云原生/7.9、使用argo_rollouts实现金丝雀发布/7.9、使用argo_rollouts实现金丝雀发布-1.png)
...
![image.png](assets/kubernetes与云原生/7.9、使用argo_rollouts实现金丝雀发布/7.9、使用argo_rollouts实现金丝雀发布-2.png)
