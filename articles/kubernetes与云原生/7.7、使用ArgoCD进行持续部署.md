...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-1.png)
...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-2.png)
...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-3.png)
...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-4.png)
...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-5.png)
...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-6.png)

填入以下信息。

![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-7.png)

验证通过后显示如下：

![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-8.png)

（2）创建应用

![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-9.png)

![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-10.png)

创建完成后如下所示：

![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-11.png)
...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-12.png)
...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-13.png)
...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-14.png)
...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-15.png)

  

这时候再手动sync以下，直到状态都变正常。再访问上面的应用。

![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-16.png)

![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-17.png)
...
![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-18.png)

还可以看到部署历史。

![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-19.png)

也可以通过这个界面进行回滚。

![image.png](assets/kubernetes与云原生/7.7、使用ArgoCD进行持续部署/7.7、使用ArgoCD进行持续部署-20.png)
