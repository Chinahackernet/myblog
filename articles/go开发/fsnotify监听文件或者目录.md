...
官方文档：[https://godoc.org/github.com/fsnotify/fsnotify](https://godoc.org/github.com/fsnotify/fsnotify)
...
![image.png](assets/go开发/fsnotify监听文件或者目录/fsnotify监听文件或者目录-1.png)
...
![image.png](assets/go开发/fsnotify监听文件或者目录/fsnotify监听文件或者目录-2.png)