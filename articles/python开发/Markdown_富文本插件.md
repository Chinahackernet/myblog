Markdown富文本因为其简洁，逻辑分明，语法简单受广大朋友的热爱。我们在做一些博客开发或者后台管理开发的时候都会大量使用富文本，由于普通的富文本编辑器的排版需要去点点点，所以我对它一直谈不上喜欢，昨天在逛github的时候偶然发现了一个在Django中使用的Markdown插件，接下来就介绍一下这个插件是如何使用的，以下内容主要来自官方文档，该项目是基于Editor.md。

> github地址：[https://github.com/pylixm/django-mdeditor](https://github.com/pylixm/django-mdeditor)
...
功能介绍比较少，主要就是为了提供Markdown富文本功能，下面我们来实际使用以下。
...
![](assets/python开发/Markdown_富文本插件/Markdown_富文本插件-1.jpeg)
