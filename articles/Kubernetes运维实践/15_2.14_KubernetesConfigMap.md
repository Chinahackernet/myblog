---
title: 2.14 Kubernetes ConfigMap
---

- [Kubernetes ConfigMap](#kubernetes-configmap)

- [ConfigMap 介绍](#configmap-介绍)
- [ConfigMap 项目演示](#configmap-项目演示)

- [1. 使用Yaml文件创建ConfigMap](#1-使用yaml文件创建configmap)
- [2.使用kubectl创建](#2使用kubectl创建)
- [3.使用环境变量引用configmap](#3使用环境变量引用configmap)
- [4.通过命令引用configmap](#4通过命令引用configmap)
- [4.通过数据卷挂载引用configmap](#4通过数据卷挂载引用configmap)
...
**配置文件变量引用**
比如我们需要创建多个环境变量，这里可以直接引用配置文件的方式
