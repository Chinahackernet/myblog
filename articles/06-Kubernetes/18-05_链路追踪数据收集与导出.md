...
> 原文：https://www.cuiliangblog.cn/detail/section/216677625
> 来源：崔亮的博客
...
![](assets/06-Kubernetes/513f134c2a4656944d3d.png)
...
![](assets/06-Kubernetes/ae3765db8de9eb561c64.png)
...
![](assets/06-Kubernetes/6701be263fd0ef18d281.png)
...
![](assets/06-Kubernetes/8e4a047bc5c74489a505.png)
...
创建 s3 的 bucket、ak、sk 资源，并配置权限。具体可参考文档：[03-10_%E9%83%A8%E7%BD%B2MinIO%E5%AF%B9%E8%B1%A1%E5%AD%98%E5%82%A8.md](articles/06-Kubernetes/03-10_部署MinIO对象存储.md)
...
修改配置，prometheus 默认未启用远程写入，可参考文章开启远程写入[03-14_%E9%83%A8%E7%BD%B2Prometheus%E7%9B%91%E6%8E%A7.md](articles/06-Kubernetes/03-14_部署Prometheus监控.md)
  ...
  storage:
    trace: # 默认使用本地文件存储，改为使用s3对象存储
      ...
      s3:
        ...
        access_key: CHANGE_ME                                 # optional. access key when using static credentials.
        secret_key: CHANGE_ME             # optional. secret key when using static credentials.
...
![](assets/06-Kubernetes/6c4d1c5e4de4ae75f90b.png)

查看 traces 数据

![](assets/06-Kubernetes/699c9cde9c7120a9268e.png)
...
![](assets/06-Kubernetes/d0a8629f9ffe6bbe6c14.png)

3. grafana 数据源启用节点图与服务图，配置如下

![](assets/06-Kubernetes/c6f797c1b93d8bcd54f6.png)

4. 查看服务图数据

![](assets/06-Kubernetes/b2cfdb56f72b2ddaecea.png)
