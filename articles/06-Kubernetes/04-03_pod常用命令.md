...
> 原文：https://www.cuiliangblog.cn/detail/section/15234028
> 来源：崔亮的博客
...
# 使用命令行创建pod资源
kubectl run rockylinux -it --image=swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/rockylinux/rockylinux:9 -- bash
```
