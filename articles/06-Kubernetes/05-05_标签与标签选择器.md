...
> 原文：https://www.cuiliangblog.cn/detail/section/15261627
> 来源：崔亮的博客
...
![](assets/06-Kubernetes/dddf58e307d481c610e6.png)

2. 在“kubectl get pods”命令中使用“--show-labels”选项，以额外显示对象的标签信息：  
$ kubectl get pods --show-labels

![](assets/06-Kubernetes/cab9df0a38bf50da7914.png)

3. 按需进行添加标签操作。  
$ kubectl label pods/pod-with-labels version=v1

![](assets/06-Kubernetes/9dac486b7fb06533a345.png)

4. 对于已经附带了指定键名的标签，使用“--overwrite”命令以强制覆盖原有的键值  
$ kubectl label pods/pod-with-labels version=v2 --overwrite

![](assets/06-Kubernetes/f0b5e06f02775d25de2d.png)

5. 删除指定键名的标签，使用“标签名-”，即可删除

![](assets/06-Kubernetes/2d0848416ddd054fe755.png)
...
![](assets/06-Kubernetes/c4e6bf7a46620591574c.png)
...
![](assets/06-Kubernetes/533b4d31fe8b68608167.png)
