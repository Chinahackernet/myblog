...
> 原文：https://www.cuiliangblog.cn/detail/section/208156714
> 来源：崔亮的博客
...
## mysql 部署
具体可参考文档[10-01_linux_rpm%E5%AE%89%E8%A3%85.md](articles/07-Database/10-01_linux_rpm安装.md)
...
```bash
mysql> CREATE USER 'replication_user'@'192.168.10.202' IDENTIFIED BY 'CHANGE_ME';
...
```bash
mysql> CREATE USER 'replication_user'@'192.168.10.201' IDENTIFIED BY 'CHANGE_ME';
Query OK, 0 rows affected (0.00 sec)
