...
> 原文：https://www.cuiliangblog.cn/detail/section/31451567
> 来源：崔亮的博客
...
![](assets/07-Database/da26f67751fe8c20b9f6.png)

 

![](assets/07-Database/cd457febb391d2f34ccb.png)

1. 2班3班中哪些同学的身高比1班的平均身高高？

mysql> select * from stu where cno in (2,3) and height>(select avg(height) from stu where cno=1);

![](assets/07-Database/b18e1c806a3c6d4959df.png)

 

![](assets/07-Database/cb7e5311aed9f2702a96.png)

1. 每个班的高考状元都是谁？

mysql> select * from stu where (cno,score) in (select cno,max(score) from stu group by cno) and cno is not null;

![](assets/07-Database/101f3fd11f0e4edb2e5c.png)

 

![](assets/07-Database/ac67f12798ae6cff208d.png)
...
![](assets/07-Database/4d4ad2179f2315b81733.png)

 

![](assets/07-Database/73eedc78cea2460acddd.png)
...
![](assets/07-Database/23eb1b50c55a9f64eb98.png)

 

![](assets/07-Database/a7720e6d4ba97350bc26.png)

1. 不用多表连接方式，列出3班学生姓名和3班的班主任

mysql> select sname 学生姓名,(select teacher from class where cno=3) 班主任 from stu o where cno=3;

![](assets/07-Database/143e6986c2fa13e8e7e4.png)

 

![](assets/07-Database/d7b0a8c720e725052a11.png)
...
![](assets/07-Database/87232a1f6cfc2b30fea4.png)
...
![](assets/07-Database/701c9ad188da569fdaa1.png)
