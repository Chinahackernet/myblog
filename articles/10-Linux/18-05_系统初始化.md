...
> 原文：https://www.cuiliangblog.cn/detail/section/31516151
> 来源：崔亮的博客
...
# 安装常用软件
```bash
dnf -y install epel-* vim tar git wget gcc gcc-c++ net-tools telnet bash-completion nc open-vm-tools && dnf -y update
```
