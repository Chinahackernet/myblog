...
> 分类：Linux / 第9章：进程管理
> 原文：https://www.cuiliangblog.cn/detail/section/31508396
> 来源：崔亮的博客

---

# 一、简介
1. nohup 命令运行由 Command参数和任何相关的      Arg参数指定的命令，忽略所有挂断（SIGHUP）信号。在注销后使用 nohup 命令运行后台中的程序。要运行后台中的 nohup 命令，添加      & （ 表示“and”的符号）到命令的尾部。
...
3. &是指在后台运行，但当用户推出(挂起)的时候，命令自动也跟着退出
