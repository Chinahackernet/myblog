...
> 分类：Linux / 第8章：系统管理
> 原文：https://www.cuiliangblog.cn/detail/section/31508275
> 来源：崔亮的博客
...
![](assets/10-Linux/b72353236354e693f641.png)
...
![](assets/10-Linux/5d4881e7f2c03ee0d9c7.png)

 

![](assets/10-Linux/6b480b773c0268db495b.png)

 

![](assets/10-Linux/f86ba4bc0c5178891284.png)

1. 修改网卡配置文件

![](assets/10-Linux/8482446eed5d6dfdaf9f.png)
...
![](assets/10-Linux/21f4aeaa4987cabf7c1f.png)

      ethx：查看某个以太网卡配置信息

![](assets/10-Linux/d51af91de5305fa628e1.png)

      ifconfig ethx IP/MASK    例如：ifconfig eth0 192.168.1.100/24   给ethx这个网络接口配置静态IP地址

![](assets/10-Linux/b0efe3ecf6e9ebccfbc4.png)

      ifconfig ethx:x IP/MASK up   给网卡配置多个IP地址并生效

![](assets/10-Linux/d419c60aa076d3c30aa0.png)

      Ifconfig ethx:x del IP     删除IP地址   例如：

![](assets/10-Linux/c3996b42a36c7e8258f4.png)
...
![](assets/10-Linux/58626b70f0a83bb2fcd0.png)
...
![](assets/10-Linux/31cdb5209eb7dd436e82.png)

addr：show [[dev] interface]  label可以指定别名

![](assets/10-Linux/44b041acc1fda4c959cf.png)

 

      add IP/MASK dev interface 为网卡添加地址 例如：ip addr add 192.168.1.100/24 dev eth0

![](assets/10-Linux/73c07cca5909e85ecd83.png)

 

      del：删除网卡上指定的IP地址，格式同上

![](assets/10-Linux/04275ca31f108e96b04a.png)

 

      flush：清空所有IP地址（谨慎使用）                  例如ip addr flush dev eth0

![](assets/10-Linux/0ccde1f3489421697161.png)
...
![](assets/10-Linux/186776ed6cc35220b77a.png)

      add：添加路由    ip route add IP/MASK via next_hop  例如：ip route add 192.168.1.100 via 192.168.2.1

![](assets/10-Linux/dbdcbdfa4da7c5853e69.png)

      del：删除路由    ip route del IP/MASK

![](assets/10-Linux/94bc8db47d56391207de.png)
...
![](assets/10-Linux/34d95da1744bdd413cf6.png)
...
![](assets/10-Linux/e03e242cf960a5e167c1.png)
...
![](assets/10-Linux/22ef8c8937394fed0b00.png)
