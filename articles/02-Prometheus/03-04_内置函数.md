...
> 原文：https://www.cuiliangblog.cn/detail/section/23396535
> 来源：崔亮的博客
...
<font style="background-color:rgb(241, 243, 245);">delta(v range-vector)</font> 的参数是一个区间向量，返回一个瞬时向量。它计算一个区间向量 v 的第一个元素和最后一个元素之间的差值。由于这个值被外推到指定的整个时间范围，所以即使样本值都是整数，你仍然可能会得到一个非整数值。  
