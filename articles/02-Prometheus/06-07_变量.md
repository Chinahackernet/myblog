...
> 原文：https://www.cuiliangblog.cn/detail/section/23468178
> 来源：崔亮的博客
...
![](assets/02-Prometheus/ebadfe70c66fda9886ca.png)
...
![](assets/02-Prometheus/838f407353f822722bb0.png)

![](assets/02-Prometheus/fa0542b95265ef351a7c.png)

1. 通过指定正则匹配表达式为/.*instance="([^"]*).*/从而匹配出标签instance的值作为node变量的所有可选项

![](assets/02-Prometheus/4e4b4f3be7859d241ad2.png)

1. Selection Options选项中可以指定该变量的下拉框是否支持多选，以及是否包含全选（All）选项。

![](assets/02-Prometheus/ebba78819635ca2dfc49.png)

1. 保存变量后，用户可以在Panel的General或者Metrics中通过$node的方式使用该变量，如下所示：

![](assets/02-Prometheus/d15e5c0cae82535239c0.png)
...
![](assets/02-Prometheus/a39f10691793c97c5c49.png)

+ 通过使用label_values函数，获取到当前Promthues监控指标up中所有可选的job标签的值：label_values(up,      job)
1. General中的Repeat选项

![](assets/02-Prometheus/334580225d199bab9eb6.png)
...
![](assets/02-Prometheus/55147c53655f517fe062.png)

1. 如果还希望能够自动生成Row，只需要在Row的设置中，选择需要Repeat的变量即可：

![](assets/02-Prometheus/0f3c72f5e1cca1e530f9.png)
