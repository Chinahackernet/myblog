...
> 分类：Docker / 第8章：网络管理
> 原文：https://www.cuiliangblog.cn/detail/section/29394479
> 来源：崔亮的博客
...
![](assets/11-Docker/f7d9dbed187aafe780c9.png)
...
![](assets/11-Docker/64177e38e8603ab77948.png)
...
![](assets/11-Docker/fbde77be47b11395e7ff.png)
...
![](assets/11-Docker/562d34e2ee83933877c3.png)

![](assets/11-Docker/351abfc99e40362a5757.png)

+ 运行容器，使用docker1网络

[root@docker ~]# docker run -it --network docker1 busybox

![](assets/11-Docker/734833dd96bd04b9f98e.png)

+ 运行容器，指定ip地址

[root@docker ~]# docker run -it --network docker1 --ip 192.168.0.100 busybox

![](assets/11-Docker/7145131b989485f621a8.png)
...
![](assets/11-Docker/d57706a18a63a3a96613.png)

+ 容器中增加了一个网卡 eth1，分配了docker1 的 IP 192.168.0.3。使用busybox访问测试

![](assets/11-Docker/e44ab98add5f1db716d6.png)
...
![](assets/11-Docker/38b2e5dc74d162d98367.png)
...
![](assets/11-Docker/761c68a4a7b5ac8c1cbb.png)
...
![](assets/11-Docker/4027d6937757962f3ba0.png)
...
![](assets/11-Docker/4c5730175e1238f7fe31.png)

+ node2主机查看网络

![](assets/11-Docker/5f543eb3e6f6d573eb6e.png)

![](assets/11-Docker/11a67709a2f4917bf9f0.png)
...
![](assets/11-Docker/2df10bfe99740e0b8682.png)

+ 运行容器后会在宿主机上生成一个overlay网桥

![](assets/11-Docker/2e2e182e0bf0c47e000d.png)
...
![](assets/11-Docker/de6106b011f3c676ecc8.png)

+ bbox2访问bbox1

![](assets/11-Docker/778061424eb6086285d3.png)
...
![](assets/11-Docker/b3903a2b63946a3efb9e.png)
...
![](assets/11-Docker/4bc3b12abd786d7c9281.png)

![](assets/11-Docker/54d92a7249ae1dfd12a4.png)

+ 测试与bbox1、bbox2网络连通性

![](assets/11-Docker/7bae073559095f260af1.png)

+ 网络拓扑

![](assets/11-Docker/26e1a678678398a176bf.png)
