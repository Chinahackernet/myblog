...
> 原文：https://www.cuiliangblog.cn/detail/section/151429534
> 来源：崔亮的博客
...
# 验证
[root@ES01 elasticsearch]# curl --cacert /opt/elasticsearch/config/certs/http_ca.crt https://elastic:CHANGE_ME@127.0.0.1:9200
{
  "name" : "ELP-T-VM-ES01",
...
## 访问验证
![](assets/01-ELK-Stack/c9b203c3bb83ee45cc56.png)

# 升级elastic agent版本
先升级fleet-server 再升级elastic-agent，使用kibana在线升级即可。

![](assets/01-ELK-Stack/3f5e4228ebc00bbc86f7.png)
