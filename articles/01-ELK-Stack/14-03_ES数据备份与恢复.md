...
> 原文：https://www.cuiliangblog.cn/detail/section/162609627
> 来源：崔亮的博客
...
[root@es-fleet2 ~]# docker run -d -p 9000:9000  -p 9090:9090  --name minio  -v /data/minio:/data -e "MINIO_ROOT_USER=root" -e "MINIO_ROOT_PASSWORD=CHANGE_ME --restart always quay.io/minio/minio server /data --console-address ":9090"
```
