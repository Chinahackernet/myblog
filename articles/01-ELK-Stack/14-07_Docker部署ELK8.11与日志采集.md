...
> 原文：https://www.cuiliangblog.cn/detail/section/162609533
> 来源：崔亮的博客
...
![](assets/01-ELK-Stack/c76f18343f24d3bb7f70.png)
...
</font>![](assets/01-ELK-Stack/0478234432a3e5f0a642.png)

<font style="color:rgb(48, 49, 51);">metrics填写http://logstash:9600，代理策略选择Fleet Server Policy即可。  
</font>![](assets/01-ELK-Stack/7cacbcc8980a6b1984c1.png)

# 访问验证
## 查看monitor信息
![](assets/01-ELK-Stack/85b9b1a42269a32e20f2.png)

## 查看数据流信息
在kibana的索引管理中，查看数据流信息，已成功创建数据流，并向其中持续写入数据。

![](assets/01-ELK-Stack/39205adc13fd4fa5c1c2.png)

## 查看字段信息
在discover中可以看到写入es的数据，已经是logstash处理过的数据内容。![](assets/01-ELK-Stack/61edc1c6cf46141c119b.png)
