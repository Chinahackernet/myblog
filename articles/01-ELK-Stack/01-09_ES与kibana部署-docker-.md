...
> 原文：https://www.cuiliangblog.cn/detail/section/117075458
> 来源：崔亮的博客
...
## 启动ES容器
```bash
[root@elk ]# docker run -d --name elasticsearch --net elk --ip 172.18.0.100 -p 9200:9200 -v $PWD/es-data:/usr/share/elasticsearch/data -v $PWD/es-log:/usr/share/elasticsearch/logs -e "discovery.type=single-node" -m 1GB docker.elastic.co/elasticsearch/elasticsearch:8.10.4
```
...
## 启动Kibana容器
```bash
[root@elk ]# docker run --name kibana -d --net elk -p 5601:5601 docker.elastic.co/kibana/kibana:8.10.4
```
...
![](assets/01-ELK-Stack/6e42a8d3a2399a34b606.png)
...
![](assets/01-ELK-Stack/4248a83452c36f2e5f15.png)
...
New value: VSxehEarmf-UfqCaLAzZ
```

kibana填写es账号密码

![](assets/01-ELK-Stack/83faec215904ac83d9f1.png)

kibana登录成功

![](assets/01-ELK-Stack/92f85cee30b52bccfaa3.png)
...
```bash
[root@elk ]# curl -k -u 'elastic:VSxehEarmf-UfqCaLAzZ' https://127.0.0.1:9200/_cluster/health
...
[root@elk ]# curl -k -u 'elastic:VSxehEarmf-UfqCaLAzZ' https://127.0.0.1:9200/_cat/nodes?v
...
![](assets/01-ELK-Stack/6ea14db960d3261de95d.png)
...
## 获取es集群uuid
![](assets/01-ELK-Stack/82cb9e77a1f865903a81.png)
...
![](assets/01-ELK-Stack/01ba27403df0bf0abf88.png)
