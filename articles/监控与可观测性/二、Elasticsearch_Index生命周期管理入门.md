...
![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-1.png)
...
![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-2.png)
...
![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-3.png)

# 准备数据

运行起来我们的Kibana:

![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-4.png)

我们分别点击上面的1和2处：

![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-5.png)

点击上面的“Add data”。这样我们就可以把我们的kibana\_sample\_data\_logs索引加载到Elasticsearch中。我们可以通过如下的命令进行查看：
...
![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-6.png)

它显示kibana\_sample\_data\_logs具有11.1M的数据，并且它有14074个文档。
...
![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-7.png)

紧接着点击“Index Lifecycle Policies”：

![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-8.png)

再点击“Create Policy”:

![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-9.png)

![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-10.png)
...
![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-11.png)
...
在这里，我们使用之前我们已经导入的测试数据kibana\_sample\_data\_logs，我们可以通过如下的方法来写入数据：
...
上面的意思是每秒按照500个文档从kibana\_sample\_data\_logs索引reindex文档到logs别名所指向的index。我们运行后，通过如下的命令来查看最后的结果：
...
![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-12.png)
...
![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-13.png)
...
![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-14.png)
...
![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-15.png)

![](assets/监控与可观测性/二、Elasticsearch_Index生命周期管理入门/二、Elasticsearch_Index生命周期管理入门-16.png)

分类: [ELK Stack](https://www.cnblogs.com/sanduzxcvbnm/category/1524488.html)