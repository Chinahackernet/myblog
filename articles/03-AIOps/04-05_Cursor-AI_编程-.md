...
> 分类：AIOPS / 第4章：大模型工具
> 原文：https://www.cuiliangblog.cn/detail/section/232745699
> 来源：崔亮的博客
...
![](assets/03-AIOps/e52150e9d03137ed2ff4.png)

# 安装
 双击安装包，无脑下一步既可。

![](assets/03-AIOps/a41f0ad6e681d0458be8.png)
...
![](assets/03-AIOps/13a4c7188e69fcc772d9.png)

## 设置中文
 选择file—>preferences—>Extension——>输入chinese，找到中文简体插件，使用install——>重启 cursor

![](assets/03-AIOps/08282a448b293776e5c7.png)

# 使用
## AI 对话
 我们打开一个项目，右侧我们可以直接进行询问

![](assets/03-AIOps/d35f5db3eea6bfd28986.png)
...
![](assets/03-AIOps/0ee1e920220d076ed7eb.png)

## 关于代码片段
我们选中一段代码，按下Ctrl+K，即可弹出对话框，我们可以在这段对话框中对这部分代码输入命令或者提问 

![](assets/03-AIOps/d3330e0570bc9d0c00af.png)

## 对整个项目或者文件进行操作
 我们按下Ctrl + L，可以看到左侧出现对话框，在这里我们可以选择对整个文件进行操作还是对项目进行操作。

![](assets/03-AIOps/1559a8f3542f900a8dd9.png)
