...
> 分类：AIOPS / 第6章：MCP
> 原文：https://www.cuiliangblog.cn/detail/section/231159403
> 来源：崔亮的博客
...
# UV 工具介绍
MCP开发要求借助uv进行虚拟环境创建和依赖管理。`uv` 是一个Python 依赖管理工具，类似于 `pip` 和 `conda`，但它更快、更高效，并且可以更好地管理 Python 虚拟环境和依赖项。它的核心目标是替代 `pip`、`venv` 和 `pip-tools`，提供更好的性能和更低的管理开销。uv 具体使用可参考文档：[../08_Python/03-06_%E6%96%B0%E4%B8%80%E4%BB%A3%E5%8C%85%E7%AE%A1%E7%90%86%E5%B7%A5%E5%85%B7UV.md](articles/08-Python/03-06_新一代包管理工具UV.md)

# MCP 服务器开发
## 功能说明
以之前开发的天气查询助手为例演示如何进行开发，MCP 基本执行流程如下：

![](assets/03-AIOps/fd974ff8052608f9037a.png)
...
![](assets/03-AIOps/d2df11551b49b6c1a599.png)
...
![](assets/03-AIOps/576c032a624327f054f5.png)

## 运行测试
在 mcp 工具中启用天气查询工具

![](assets/03-AIOps/b0c973e019f77f4f7625.png)

访问测试

![](assets/03-AIOps/dae23097cfbefc4b7c45.png)
...
## 流程图解
![画板](assets/03-AIOps/cf8a3717a25491258a83.jpeg)
